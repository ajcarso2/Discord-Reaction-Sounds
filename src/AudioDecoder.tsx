// Borrowed code from git repo: https://github.com/kmatic/Voice-Recognition-Discord-Bot/blame/main/src/utils/createRecognitionStream.ts
import { VoiceReceiver, EndBehaviorType } from "@discordjs/voice";
import detectHotword from "./DetectHotword";
import prism from "prism-media";
import { Porcupine } from "@picovoice/porcupine-node";

export default function AudioDecoder(
